<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}">
                <img src="{{ asset('images/logo-aprepi.png') }}" alt="Logo APREPI" class="h-14">
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @guest
                    <div class="flex space-x-4">
                        <a href="{{ route('login') }}" class="text-sm text-white bg-blue-600 px-4 py-2 rounded hover:bg-blue-700">
                            {{ __('Entrar') }}
                        </a>
                    </div>
                @endguest
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('sobre-nos')" :active="request()->routeIs('sobre-nos')">
                {{ __('Sobre nós') }}
            </x-responsive-nav-link>
